...
Prob 2. 设 $K \subseteq R^m$ 是凸开集. 证明凸函数 $f:K \to R$ 是局部 Lipschitz 函数, 即对 $x_0 \in K$, 存在邻域 $U$ 和 $L > 0$, 对 $x, y \in U$ 有 $|f(x)-f(y)| \le L\lVert x-y \rVert$.
