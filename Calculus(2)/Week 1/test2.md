...
取 $0 < \delta_1 < r$ 满足 $|x-x_0| < \delta_1 \to |f(x, y_0 - \delta_0) - f(x_0, y_0 - \delta_0)| < \frac{1}{2}\epsilon$. 取 $0 < \delta_2 < r$ 满足 $|x-x_0| < \delta_1 \to |f(x, y_0 + \delta_0) - f(x_0, y_0 + \delta_0)| < \frac{1}{2}\epsilon$.
