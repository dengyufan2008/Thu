...
对于任意 $(x_0, y_0) \in G$, 存在 $r > 0$ 使得 $r$ 邻域在 $G$ 内. 对于任意 $\epsilon > 0$, 可以取 $\delta_1$ 使得 $|x-x_0| < \delta_1 \to |f(x, y_0) - f(x_0, y_0)| < \frac{1}{2}\epsilon$. 又可以取 $\delta < \min(\delta_1, \frac{1}{2k}\epsilon, r)$.
